...
export default function Intermediate({ route, navigation }) {
  ...
  console.log(`[DEBUG Intermediate] Level ${level}: word="${levels[level]?.word}", hint="${currentHint}"`);
...
const styles = StyleSheet.create({
  ...
  key: { width: 60, height: 48, backgroundColor: "#4C9EEB", margin: 6, borderRadius: 8, justifyContent: "center", alignItems: "center" },
